...
boolean isCutoff = vm.isSectorCutoff();
demoSectorBtn.setText("Simuler coupure");
if (isCutoff) {
demoSectorBtn.getStyleClass().add("active");
networkStatusLabel.setText("🔴 Coupure réseau");
networkStatusLabel.setStyle("-fx-font-size: 11px; -fx-font-weight: 600; -fx-text-fill: #FF6B6B; -fx-font-family: 'Inter', sans-serif;");
} else {
demoSectorBtn.getStyleClass().remove("active");
networkStatusLabel.setText("🟢 Réseau disponible");
networkStatusLabel.setStyle("-fx-font-size: 11px; -fx-font-weight: 600; -fx-text-fill: #22D3A5; -fx-font-family: 'Inter', sans-serif;");
}
}
